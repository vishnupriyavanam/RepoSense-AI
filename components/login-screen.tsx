...
export function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  const [email, setEmail] = useState("demo@reposense.ai")
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center">
          ...
          <div className="relative w-72 h-72 mb-10">
            ...
            <div className="absolute inset-4 rounded-full bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/20 flex items-center justify-center overflow-hidden">
              <div className="absolute inset-0">
                <div className="absolute top-8 left-8 text-primary/40 text-2xl font-mono animate-float">
                  {"{ }"}
                </div>
                <div className="absolute top-12 right-10 text-accent/40 text-xl font-mono animate-float-delayed">
                  {"</>"}
                </div>
                <div className="absolute bottom-16 left-12 text-primary/30 text-lg font-mono animate-float">
                  {"[ ]"}
                </div>
                <div className="absolute bottom-10 right-8 text-accent/30 text-xl font-mono animate-float-delayed">
                  {"( )"}
                </div>
              </div>
          ...
          <div className="flex gap-6">
            <div className="flex flex-col items-center text-center max-w-[140px]">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Analyze repositories with AI insights
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center max-w-[140px]">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Get project-specific improvements
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center max-w-[140px]">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Improve resume and portfolio quality
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-5">
              <div className="text-center">
                <h2 className="text-xl font-semibold mb-1 text-foreground">
                  Try RepoSense AI <span className="inline-block">🚀</span>
                </h2>
              ...
              <div className="p-3 rounded-lg bg-primary/10 border border-primary/20">
                <p className="text-xs text-primary text-center leading-relaxed">
                  This is a portfolio demo. Authentication, password reset, and user accounts
              ...
              <div className="text-center text-xs text-muted-foreground">
                No account required. Explore all features in demo mode.
              </div>
            </div>
          </div>
        </div>
